...
public class CurrentBHistoryFrag extends Fragment {
    ...
    public static CurrentBHistoryFrag InstanceClean(String s) {
        CurrentBHistoryFrag frag = new CurrentBHistoryFrag();
